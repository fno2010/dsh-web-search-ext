...
/**
 * Register both providers with `ctx.web`, install the Settings section, and
 * ensure the model-facing `web_fetch` tool is available. `settings.yaml` (or
 * the settings card) edits the same config both providers serve — live,
 * without restart.
 */
